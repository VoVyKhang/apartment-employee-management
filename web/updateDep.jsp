    ...
    <body>
        ...
        <c:import url="sidebar.jsp"></c:import> 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput" name="depname" placeholder="Example input" value="${requestScope.Dep.depName}">
                <p style="color:red">${requestScope.messName}</p>
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput2">Description</label>
                <input type="text" name="depdes" class="form-control" id="formGroupExampleInput2" placeholder="Another input" value="${requestScope.Dep.description}">
                <p style="color:red">${requestScope.messDes}</p>
            </div>
            <div class="form-group">
                <label for="formGroupExampleInput2">Location</label>
                <input type="text" name="deploc" class="form-control" id="formGroupExampleInput2" placeholder="Another input" value="${requestScope.Dep.location}">
                <p style="color:red"> ${requestScope.messLoc}</p>
                <p style="color:red">${requestScope.WARNING}</p>
            </div>
            <div class="form-position__btn">
                <input type="hidden" name="depnum" value="${requestScope.Dep.depNum}" >
