 ...
 * @author lehon
 */
public class passOjDepController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                dep = DepartmentDAO.getDepByDepnum(depNum);
            } catch (SQLException ex) {
                Logger.getLogger(passOjDepController.class.getName()).log(Level.SEVERE, null, ex);
            }
